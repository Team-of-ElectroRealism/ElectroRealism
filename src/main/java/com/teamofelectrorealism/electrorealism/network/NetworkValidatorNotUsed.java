...
// */
//public class NetworkValidatorNotUsed {
...
//        Map<INetworkMember, List<ConnectionInfo>> adjacencyList = new HashMap<>();
//
//        for (INetworkMember member : members) {
//            adjacencyList.putIfAbsent(member, new ArrayList<>()); // Ensure all members have an entry
//
...
//
//                            adjacencyList.computeIfAbsent(member, k -> new ArrayList<>())
...
//                        adjacencyList.computeIfAbsent(member, k -> new ArrayList<>()).add(new ConnectionInfo(attachedMachine, MACHINE_FACE_INDEX_DUO_0, MACHINE_FACE_INDEX_SINGLE, ConnectorPolarity.NONE)); // Machine side polarity is NONE
//                        adjacencyList.computeIfAbsent(member, k -> new ArrayList<>()).add(new ConnectionInfo(attachedMachine, MACHINE_FACE_INDEX_DUO_1, MACHINE_FACE_INDEX_SINGLE, ConnectorPolarity.NONE));
//                    } else {
...
//                        adjacencyList.computeIfAbsent(member, k -> new ArrayList<>()).add(new ConnectionInfo(attachedMachine, MACHINE_FACE_INDEX_SINGLE, MACHINE_FACE_INDEX_SINGLE, ConnectorPolarity.NONE)); // Machine side polarity is NONE
//                    }
//
...
//                        ConnectorPolarity p0 = connectorState.getValue(DuoConnectorBlock.TERMINAL_TYPE_0);
//                        ConnectorPolarity p1 = connectorState.getValue(DuoConnectorBlock.TERMINAL_TYPE_1);
//                        adjacencyList.computeIfAbsent(attachedMachine, k -> new ArrayList<>()).add(new ConnectionInfo(member, MACHINE_FACE_INDEX_SINGLE, MACHINE_FACE_INDEX_DUO_0, p0)); // Polarity entering connector is p0
//                        adjacencyList.computeIfAbsent(attachedMachine, k -> new ArrayList<>()).add(new ConnectionInfo(member, MACHINE_FACE_INDEX_SINGLE, MACHINE_FACE_INDEX_DUO_1, p1)); // Polarity entering connector is p1
//                    } else {
...
//                        adjacencyList.computeIfAbsent(attachedMachine, k -> new ArrayList<>()).add(new ConnectionInfo(member, MACHINE_FACE_INDEX_SINGLE, MACHINE_FACE_INDEX_SINGLE, connectorPolarity));
//                    }
//                }
//            }
//        }
