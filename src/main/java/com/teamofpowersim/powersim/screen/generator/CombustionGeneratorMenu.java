package com.teamofpowersim.powersim.screen.generator;
...
public class CombustionGeneratorMenu extends AbstractContainerMenu {
    ...
    public CombustionGeneratorMenu(int containerId , Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CombustionGeneratorMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData containerData) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0, 80, 41));
